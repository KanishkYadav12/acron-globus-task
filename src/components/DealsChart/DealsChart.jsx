...
import { ChevronDownIcon, FilterIcon, BarChartIcon } from "../../icons";
import "./DealsChart.css";

function DealsChart() {
  return (
    <div className="card deals-chart">
      ...
      <div className="bar-chart">
        <div className="bar white-bar bar--behance">Bē</div>
        <div className="bar line-bar bar--dribbble">
        ...
        <div className="bar white-bar bar--google">
        ...
        <div className="bar white-bar bar--instagram">
        ...
        <div className="bar line-bar bar--clipboard">
          <svg
            viewBox="0 0 24 24"
            width="14"
            height="14"
      ...
      <div className="bar-chart__footer">
        <span className="bar-chart__label">Deals amount</span>
        <span className="bar-chart__label-sub">
